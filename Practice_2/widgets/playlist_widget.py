...
class PlaylistWidget:
    def __init__(self, playlist_name, free_space):
        ...
        if len(playlist_name) > free_space:
            playlist_name = playlist_name[:int(free_space)] + "..."

        widgetlabel = QtWidgets.QLabel(playlist_name)
